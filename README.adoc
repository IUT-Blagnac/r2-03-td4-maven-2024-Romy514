...
On change le main dans pom.xlm afin de pouvoir compiler et exécuter le code source ajouté
...
On écrit dans la console mvn javadoc:javadoc pour générer la javadoc.
